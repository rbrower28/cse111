...
def print_death_age(people_dict):
    ...
    for i in people_dict:
        ...
        death_age = dodeath - dobirth

        print(f"{name}, {dobirth}-{dodeath}: {death_age}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for i in marriages_dict:
        ...
        marriage = marriages_dict[i]

        husband = people_dict[marriage[0]]
        wife = people_dict[marriage[1]]
        ...
        wed_age_h = wed_date - husband[2]
        wed_age_w = wed_date - wife[2]

        print(f"{husband_name} {wed_age_h} > {wed_date} < {wife_name} {wed_age_w}")
...
def count_marriages(marriages_dict, people_dict):
    ...
    for i in people_dict:
        ...
        for m in marriages_dict:

            husband = marriages_dict[m][0]
            wife = marriages_dict[m][1]

            if i == husband or i == wife:
                marriages += 1
