...
def estimate_reduction(row, behavior_key, perc_reduc):
    ...
    try:
        ...
        print(error)
        print(f"Whoops! It looks like a number in the {FATAL_CRASHES_COLUMN} column is 0, and needs to be changed.")
    except:
...
# def check_zero(formula):
#     global FATAL_CRASHES_COLUMN
